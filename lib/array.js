 ...
 */
 ...
 !(function (exports) {
  ...
  /**
   * Produce a duplicate-free version of 'self',
  ...
  /**
   * Compute the union of the passed-in arrays.
   *
  ...
  array.intersection = function (self) {
    var result = []
      , arrays = slice.call(arguments, 1)
      , n = arrays.length
      , value
  ...
  /**
   * Return the values from 'self' that are not present in 'other' arrays.
   *
   * @param {Array} self array
  ...
  array.difference = function (self, other) {
    var result = []
      , len = self.length
      , value
      , i
  ...
  /**
   * Merge together the values of each of the arrays
