 ...
 */
 ...
 !(function (exports) {
   ...
   * @param {Function} iterator iterator
   * @param {Object} context context
   * @return true if every value in 'self' pass 'iterator' in 'context'
   * @api public
   */
   ...
   * @param {Function} iterator iterator
   * @param {Object} context context
   * @return true if some value in 'self' pass 'iterator' in 'context'
   * @api public
   */
   ...
   * @param {Array} self array
   * @param value value
   * @return true if 'self' include 'value', false otherwise
   * @api public
   */
